...
const (
	// Label holds the string label denoting the learnedlexeme type in the database.
	Label = "learned_lexeme"
	...
	EdgeWord = "word"
	// Table holds the table name of the learnedlexeme in the database.
	Table = "learned_words"
...
// Columns holds all SQL columns for learnedlexeme fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldTerm,
...
var (
	...
	DefaultRelations []entity.LearnedLexemeRelation
...
// OrderOption defines the ordering options for the LearnedLexeme queries.
