...
const (
	// Label holds the string label denoting the userword type in the database.
	Label = "user_word"
	...
	// Table holds the table name of the userword in the database.
	Table = "user_words"
)

// Columns holds all SQL columns for userword fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldWord,
...
// OrderOption defines the ordering options for the UserWord queries.
